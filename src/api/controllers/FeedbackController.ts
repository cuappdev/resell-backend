...
export class FeedbackController {
  ...
  async getFeedbackByUserId(
    ...
    return {
      feedbacks: await this.feedbackService.getFeedbackByUserId(params),
    };
  }
  ...
  async createFeedback(
    ...
    return {
      feedback: await this.feedbackService.createFeedback(
        createFeedbackRequest,
      ),
    };
  }
  ...
  async searchFeedback(
    @Body() GetSearchedFeedbackRequest: GetSearchedFeedbackRequest,
  ): Promise<GetFeedbacksResponse> {
    return {
      feedbacks: await this.feedbackService.searchFeedback(
        GetSearchedFeedbackRequest,
      ),
    };
  }
