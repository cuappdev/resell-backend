...
export class UserReviewController {
  ...
  async getUserReviewsById(
    ...
    return {
      userReview: await this.userReviewService.getUserReviewById(params),
    };
  }

  @Post()
  async createUserReview(
    @Body() createUserReviewRequest: CreateUserReviewRequest,
  ): Promise<GetUserReviewResponse> {
    return {
      userReview: await this.userReviewService.createUserReview(
        createUserReviewRequest,
      ),
    };
  }
  ...
  async deleteUserReview(
    @CurrentUser() buyer: UserModel,
    @Params() params: UuidParam,
  ): Promise<GetUserReviewResponse> {
    return {
      userReview: await this.userReviewService.deleteUserReviewById(
        buyer,
        params,
      ),
    };
