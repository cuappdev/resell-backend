...
export class TransactionReviewController {
  ...
  @Get("id/:id/")
  async getTransactionReviewById(
  ...
  async getTransactionReviewByTransactionId(
    @Params() params: UuidParam,
  ): Promise<TransactionReviewModel> {
    return await this.transactionReviewService.getTransactionReviewByTransactionId(
      params,
    );
  }
  ...
  async createTransactionReview(
    @Body() createTransactionReviewRequest: CreateTransactionReviewRequest,
  ): Promise<TransactionReviewModel> {
    return await this.transactionReviewService.createTransactionReview(
      createTransactionReviewRequest,
    );
  }

  @Delete("id/:id/")
  async deleteTransactionReview(
    @Params() params: UuidParam,
  ): Promise<TransactionReviewModel> {
    return await this.transactionReviewService.deleteTransactionReviewById(
      params,
    );
  }
}
