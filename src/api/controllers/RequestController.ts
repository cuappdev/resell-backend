...
export class RequestController {
  ...
  async createRequest(
    ...
    return {
      request: await this.requestService.createRequest(createRequestRequest),
    };
  }
  ...
  async archiveAllRequestsByUserId(
    @Params() params: FirebaseUidParam,
  ): Promise<GetRequestsResponse> {
    return {
      requests: await this.requestService.archiveAllRequestsByUserId(params),
    };
  }

  @Get("matches/id/:id/:time?/")
  async getMatchesByRequestId(
