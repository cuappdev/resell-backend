...
export class Init1706876094061 implements MigrationInterface {
    name = 'Init1706876094061'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Blocking" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "blocker_id" uuid, "blocked_id" uuid, CONSTRAINT "PK_149f1a3dd4e82f65b05958c5329" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "Blocking" ADD CONSTRAINT "FK_e95335e67de6decdf2f514df4b1" FOREIGN KEY ("blocker_id") REFERENCES "User"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "Blocking" ADD CONSTRAINT "FK_d3c50e494801de86091b827bb0b" FOREIGN KEY ("blocked_id") REFERENCES "User"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "Blocking" DROP CONSTRAINT "FK_d3c50e494801de86091b827bb0b"`);
        await queryRunner.query(`ALTER TABLE "Blocking" DROP CONSTRAINT "FK_e95335e67de6decdf2f514df4b1"`);
