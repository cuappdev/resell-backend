...
export class addconditiontoposts1732146942548 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "Post" ADD "condition" character varying`,
    );
    await queryRunner.query(
      `UPDATE "Post" SET "condition" = 'NEW' WHERE "condition" IS NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "Post" ALTER COLUMN "condition" SET NOT NULL`,
    );
    await queryRunner.query(
