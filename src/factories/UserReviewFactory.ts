...
define(UserReviewModel, (_, context?: { index?: number, buyer?: UserModel, seller?: UserModel }) => {
  if (context === undefined || context.buyer === undefined || context.seller === undefined || context.index === undefined)
