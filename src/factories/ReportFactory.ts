...
define(ReportModel, (_, context?: { index?: number, reporter?: UserModel, reported?: UserModel, post?: PostModel, message?: MessageModel }) => {
  if (context === undefined || context.reporter === undefined || context.reported === undefined ||
    context.index === undefined || context.post === undefined || context.message === undefined)
  ...
  report.type = index % 3 === 0 ? 'message' : index % 2 === 0 ? 'profile' : 'post';
