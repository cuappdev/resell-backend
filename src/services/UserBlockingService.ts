...
export class UserBlockingService {
  ...
  public async getAllUserBlockings(user: UserModel): Promise<UserBlockingModel[]> {
  ...
  public async getAllUserBlockingsByBlockingUserId(user: UserModel, params: UuidParam): Promise<UserBlockingModel[]> {
    return this.transactions.readOnly(async (transactionalEntityManager) => {
  ...
  public async getAllUserBlockingsByBlockedUserId(user: UserModel, params: UuidParam): Promise<UserBlockingModel[]> {
    return this.transactions.readOnly(async (transactionalEntityManager) => {
  ...
  public async getUserBlockingByBothIds(params: UuidParams): Promise<UserBlockingModel | undefined> {
    return this.transactions.readOnly(async (transactionalEntityManager) => {
      const userRepository = Repositories.user(transactionalEntityManager);
  ...
  public async blockUser(blockingUserId: Uuid, blockedUserId: Uuid): Promise<UserBlockingModel> {
