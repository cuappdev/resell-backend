...
import { DatabaseConnection, DataFactory, UserFactory, BlockingFactory } from "./data";
...
beforeEach(async () => {
    ...
    expectedBlocker.photoUrl = 'https://media-exp1.licdn.com/dms/image/C5603AQGmvQtdub6nAQ/profile-displayphoto-shrink_400_400/0/1635358826496?e=1668643200&v=beta&t=ncqjrFUqgqipctcmaSwPzSPrkj0RIQHiCINup_55NNs';
    ...
    expectedBlocked.photoUrl = 'https://media-exp1.licdn.com/dms/image/C5603AQGmvQtdub6nAQ/profile-displayphoto-shrink_400_400/0/1635358826496?e=1668643200&v=beta&t=ncqjrFUqgqipctcmaSwPzSPrkj0RIQHiCINup_55NNs';
...
describe('blocking tests', () => {
  ...
  test('get all blockings - one blocking', async () => { 
    ...
    await new DataFactory()
      .createBlockings(blocking)
      .write();

    const getUserBlockingsResponse = await blockingController.getAllBlockings(user);
