...
describe("request tests", () => {
  ...
  test("get all requests - one request", async () => {
    ...
    await new DataFactory().createRequests(request).write();
  ...
  test("get all requests - multiple requests", async () => {
    ...
    await new DataFactory().createRequests(request1, request2).write();
  ...
  test("get request by id", async () => {
    ...
    const getRequestResponse =
      await requestController.getRequestById(uuidParam);
  ...
  test("get request by user id", async () => {
    ...
    const getRequestsResponse =
      await requestController.getRequestsByUserId(uuidParam);
  ...
  test("delete request by id", async () => {
    ...
    const getRequestResponse =
      await requestController.deleteRequestById(uuidParam);
